            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 " data-aos="fade-left" data-aos-delay="400">
                    <div class="image-sliders" style="max-h-[60vh]">
                        ...
                        <div>
                            <img src="{{ asset('Home') }}/images/verdant/fasad-2.jpg" class="w-100"
                                style="height: 80vh; object-fit: cover" alt="">
                        </div>
                        <!--<div>-->
                    ...
                    <div class="tab-pane fade show active" id="semua-tab-pane" role="tabpanel" aria-labelledby="semua-tab"
                        ...
                        <div class="units">
                            ...
                            <a href="/Housing/VerdantGrove" class="item">
                                <div class="item-img">
                                    <img style="width:100%;height:100%;"
                                        src="{{ asset('Home') }}/images/verdant/fasad-2.jpg" alt="">
                                </div>
                                <h6>Verdant Grove</h6>
                                <p>Malang</p>
                            </a>
    ...
    <div class="promotions" data-aos="zoom-right" data-aos-offset="0" data-aos-duration="500">
        <div class="container" style="padding-bottom: 0px">
            ...
            <div class="sliders-index container-fluid" data-aos="zoom-in"
                style="padding-bottom: 1.8rem !important; padding: 0 120px">
                <div class="sliders">
                    <div class="slider-item" style="background:none !important;">
                        <div class="slider-img">
                            <a href="{{ url('/download-pdf') }}"><img src="{{ asset('Home') }}/images/promo/web-promo.webp"
                                    class="w-100" alt="" style=" border-radius:20px;"></a>
                        </div>
                    ...
                    <div class="slider-item">
                        ...
                        <div class="slider-img">
                            <img src="{{ asset('Home') }}/images/verdant/billboard.jpg" class="w-100" alt=""
            ...
            <div class="mobile-only">
                <div class="cta-mobile">
                    <div class="sliders-mobile">
                        <div class="item">
                            <div class="item-img">
                                <a href="{{ url('/download-pdf') }}"><img
                                        src="{{ asset('Home') }}/images/promo/web-promo.webp" class="w-100" alt=""></a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="item-img">
            ...
            <div class="row items">
                <div class="col-6 col-lg-6">
                    <div class="item" data-aos="fade-left">
                        <img src="{{ asset('Home') }}/images/page-picture/greenland-banner.jpg"
                            style="height: 60vh; object-fit: cover" alt="">
                        <div class="item-text">
                            <h4>Greenland</h4>
                ...
                <div class="col-6 col-lg-6">
                    <div class="item" data-aos="fade-left">
                        <img src="{{ asset('Home') }}/images/verdant/fasad-2.jpg" style="height: 60vh; object-fit: cover"
                            alt="">
                        <div class="item-text">
                            <h4>Verdant Grove</h4>
