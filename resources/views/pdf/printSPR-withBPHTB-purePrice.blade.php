...
<body>
    ...
    <center>
           <table class="table table-borderless no-space" style="width: 100%">
                <tr>
                    <td style="width: 70%"><img style="" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('Dashboard/images/content/logo-forms-living1.png'))) }}" alt=""></td>
                    <td><img style="float: right;" class="float-right"

                        @if($fp->id_projek == 1)

                        src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('Home/images/logo-tidar-gray.png')))}}"

                        @else

                        src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('Home/images/logo-kalm.png')))}}" style="width: 100%;"
    ...
    <div class="container" style="margin-left:3rem !important;">
            ...
            <ol type="a" style="margin-right:0pt; margin-left:0pt; padding-left:0pt">
                <li class="ListParagraph"
                    ...
                    <span>Secara Cash atau
                        Cash Bertahap (inhouse) dapat melalui transfer ke rekening</span><br /><span><b>BANK CENTRAL
                        ASIA</b></span></li>
            </ol>
        </li>
    </ol>
    ...
    <p class="ListParagraph" style="margin-left:72pt; margin-bottom:8pt; text-align:justify; line-height:115%">
        <span><b>Nomor Rekening : 4400808088</b> </span>
    </p>
    ...
    <p class="ListParagraph" style="margin-left:72pt; margin-bottom:8pt; text-align:justify; line-height:115%">
        <span><b>Nomor Rekening : 4400808088 </b></span><span style="-aw-import:spaces">&#xa0;</span>
    </p>
    ...
    <ol start="16" type="I" style="margin:0pt; padding-left:0pt">
        ...
        <p style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;line-height: 114%;text-align: left;">Harga Belum
            ...
            <p style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;line-height: 114%;text-align: left;">Promo : {{$promo->promo}} - {{$promo->kode_promo}}</p>
             <p style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;line-height: 114%;text-align: left;">Detail Promo : {{$promo->keterangan}}</p>
       <br>
       <br>
        <p>
