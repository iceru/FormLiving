  ...
  <div class="container">
                ...
                <tr>
                    ...
                    <td>
                        <img style="float: right;" class="float-right"
                            src="{{ asset('Home') }}/images/logotidargreen.png" alt="">
        ...
        <table>
            ...
            <tr>
                ...
                <td > : <span style="text-transform: capitalize;">{{ $fp->alamat_plgn }}</span></td>
            </tr>
            <tr>
      ...
      <li data-list-text="5.">
        ...
        <table style="border-collapse:collapse;margin-left:38.524pt" cellspacing="0">
          <tr style="height:14pt">
            ...
            <td style="width:29pt">
              <p class="s2" style="padding-left: 3pt;text-indent: 0pt;line-height: 11pt;text-align: left;">
                Rp.
              </p>
            </td>
            <td style="width:86pt">
          ...
          <tr style="height:18pt">
            <td style="width:215pt">
              <p class="s2" style="padding-left: 2pt;text-indent: 0pt;line-height: 13pt;text-align: left;">
                d. PPN (Pajak Pertambahan Nilai)</p>
            </td>
            <td style="width:18pt">
              <p class="s2" style="padding-left: 3pt;text-indent: 0pt;line-height: 13pt;text-align: left;">
                Rp.
              </p>
            </td>
            <td style="width:86pt">
              <p class="s2" style="padding-right: 5pt;text-indent: 0pt;line-height: 13pt;text-align: right;">
