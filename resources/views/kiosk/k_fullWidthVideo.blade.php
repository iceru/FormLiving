...
<body class="kiosk">
    <a href="/kiosk/project-select-cluster.html" class="splash-screen full-width">
        <div class="header-ss">
            <div class="image-sliders">
                <div class="image">
                    <img src="{{ asset('Home') }}/images/img-greenland1.png" alt="">
                </div>
            </div>
        </div>
        <div class="content">
            <div class="content-sliders">
                <div class="item">
                    ...
                    <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dignissim interdum neque vel
                        euismod. </h4>
                </div>
            </div>
        </div>
